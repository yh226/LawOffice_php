...
<div id="header">
    <h1>
        <a href="/LawOffice_php/index.html">Home</a>
        <br>
        <a href="#">文件上传下载管理系统</a>
    </h1>
<!--	<h1 id="logo">-->
<!--		<a target="_blank" href="http://www.adminsheng.com">文件上传下载管理系统</a>-->
<!--	</h1>-->
</div>
	...
	<div class="col-sub">
		<ul id="main-menu">
			...
			<li id="help8">
		  		<span>
		  			<i class="icon"></i>
		  			<a href="http://www.adminsheng.com" target="_blank">新版更新下载</a>
		  		</span>
		  	</li>
		</ul>
	</div>
...
<div id="footer">
	CopyRight ©2015 <a href="http://www.comtechnz.com/" target="_blank">Comtech PC Solutions LTD</a> All Rights Reserved.
</div>
